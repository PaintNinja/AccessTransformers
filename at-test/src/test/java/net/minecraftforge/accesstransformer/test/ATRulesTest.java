...
import static net.minecraftforge.accesstransformer.AccessTransformer.FinalState.*;
import static net.minecraftforge.accesstransformer.AccessTransformer.Modifier.*;
